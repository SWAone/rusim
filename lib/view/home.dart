...
class home extends StatelessWidget {
  ...
  servesController cm = Get.put(servesController());
                        ...
                        ? Row(
                            ...
                            children: [
                              ineed.custmContainer(
                                ...
                                child: Center(
                                    child:
                                        ineed.custmText(data: 'اختر المجموعة')),
                                onTap: () {
                                  Get.snackbar('', '',
                                      barBlur: 20,
                                                                  ...
                                                                  return cc.items
                                                                      ...
                                                                      ? Directionality(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () {
                                                                              cc.personIndex = index;
                                                                              cc.gertPersonPoits(personDocid: cc.person[index]['id'], groupId: cc.items[cc.index]['id']);
                                                                              Get.offAll(MyHomePage());
                                                                            },
                                                                            child:
                                                                                Center(
                                                                              child: ineed.custmText(data: '${cc.person[index]['name']}', color: Colors.black, isbold: true),
                                                                            ),
                                                                          ),
                                                                        )
                                                                      : ineed.custmText(
